...
class _LecturerBrowsingState extends State<LecturerBrowsing> {
  ...
  Future<void> _bootstrap() async {
    ...
    await _fetchMe();
    await _fetchAvailability(); // initial load
  }
    ...
    try {
      ...
      if (resp.statusCode == 200) {
        ...
        if (data is Map && data['ok'] == true && data['user'] is Map) {
          ...
          if (mounted && fn.isNotEmpty) {
            setState(() => _lecturerName = 'Aj.$fn');
          }
        }
      }
    } catch (_) {}
  ...
  Future<void> _fetchAvailability() async {
    ...
    try {
      ...
      // sort: available → fully booked → disabled (same rule as student)
  ...
  Future<void> _showSlotsDialog(Map<String, dynamic> room) async {
    final timeSlotsLocal = timeSlots; // capture current
    await showDialog(
      context: context,
    ...
    return Scaffold(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () {
                  ...
                  if (!_loading) _fetchAvailability();
                },
              ),
              IconButton(
      ...
      body: Column(
        children: [
          ...
          // Category chips (refresh on change)
          Padding(
                  ...
                  child: Padding(
                    ...
                    child: ChoiceChip(
                      ...
                      onSelected: (_) async {
                        ...
                        // fetch fresh data when switching category
          ...
          // Room cards (with overlays for fully booked / disabled)
          Expanded(
            child: _loading
                      ...
                      return Container(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            // Overlay for fully booked or disabled

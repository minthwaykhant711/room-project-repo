...
class StudentBrowsingStudy extends StatefulWidget {
  ...
  @override
  State<StudentBrowsingStudy> createState() => _StudentBrowsingStudyState();
}

class _StudentBrowsingStudyState extends State<StudentBrowsingStudy> {
  final List<String> categories = ['Study', 'Multimedia', 'Meeting'];

  final List<Map<String, dynamic>> rooms = [
    {
      'name': 'Study Room A',
      'details': 'TV, Aircon, Whiteboard',
      'max': 6,
      'statuses': {
